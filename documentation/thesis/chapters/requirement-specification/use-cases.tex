...
Due to the page limits, only the main use-case description is present here. Please find reference of the use-case descriptions in Appendix-\ref{appendix:use-case-description}.
...
{\begin{CompactItemizes}
    ...
    \item Establish a port forwarding connection with \ac{lazy-koala-operator}.
\end{CompactItemizes}}
{N/A}
{Generate Report\newline
